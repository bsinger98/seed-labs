...
\lhead{\bfseries SEED Labs -- TCP Attacks Lab -- Edited by: Brian Singer and Vyas Sekar}
...
\paragraph{Note} Bash commands need to be surrounded by a return character and a newline character:
